...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-12-2024 a las 13:56:35
...
--
-- Base de datos: `bdtarea3dwes_sandrarujas`
--
CREATE DATABASE IF NOT EXISTS `bdtarea3dwes_sandrarujas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bdtarea3dwes_sandrarujas`;
...
CREATE TABLE `plantas` (
  `id` bigint(20) NOT NULL,
  `codigoplanta` varchar(255) DEFAULT NULL,
...
ALTER TABLE `plantas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UKmubd7l16aamylcjg2x6f256qi` (`codigoplanta`),
